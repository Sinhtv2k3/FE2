            ...
            <form onSubmit={handleSubmit}>
              <Stack gap={2}>
                ...
                <Button
                  variant="contained"
                  type="submit"
                  sx={{ backgroundColor: "#1976d2", color: "#fff", "&:hover": { backgroundColor: "#155a8a" } }}
                >
                  Submit
                </Button>
                {success && (
                ...
                <Typography textAlign={"center"} mt={2}>
                  Đã có tài khoản? <Link href="/login" sx={{ color: "#1976d2", "&:hover": { color: "#155a8a" } }}>Đăng nhập ngay</Link>
                </Typography>
              </Stack>
            </form>
          );
